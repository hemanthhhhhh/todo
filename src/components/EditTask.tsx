      ...
      {edit ? (
        <div className="bg-white p-4 rounded-md shadow-lg z-10 absolute border">
          ...
          <div className="flex justify-between">
            ...
            <button className="bg-gray-300 py-2 rounded-md px-2" onClick={() => setEdit(false)}>
              Cancel
            </button>
          </div>
        </div>
      ) : (
        <button onClick={() => setEdit(true)} className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
          Edit
        </button>
      )}
    </div>
